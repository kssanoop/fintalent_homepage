    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="relative">
        <div>
          ...
          <div>
            <FormLabel className="mb-1 font-semibold text-[#171717]">
              Available Time Slots
            </FormLabel>
            <p className="mb-8 w-[80%] text-sm font-semibold text-[#5E5E5E]">
              Set your available time slots for recruiters to schedule
              interviews.
            </p>
                  ...
                  <FormField
                    ...
                    render={({ field }) => {
                      return (
                        <div
                          ref={parent}
                          className="flex items-start gap-[45px]"
                        >
                          <FormItem
                            key={day}
                            className="flex w-[75px] flex-row items-center space-x-3 space-y-0"
                          >
                            <FormControl>
                              <Checkbox
                                checked={field.value}

...
import AllCandidatesTab from "./all-candidate/all-candidates-tab";
import PendingCandidateTableData from "./pending-candidates/pending-candidate-table-data";
import AdminHiredCandidatesTabs from "./hired-candidates/hired-candidates-tab";
...
import ReopenRequestTabAdmin from "./reopen-request/reopen-request-tab-admin";

...
import AssignCandidateContainer from "./assign-candidate-container";

const TeamLeadAssignCandidateSheet = ({
  teamLeadName,
}: {
  teamLeadName: string;
}) => {
      ...
      >
        <div className="px-7 py-6">
          ...
          <p className="text-[#5E5E5E]">
            Assign candidates under {teamLeadName}{" "}
          </p>
        </div>
...
export default TeamLeadAssignCandidateSheet;

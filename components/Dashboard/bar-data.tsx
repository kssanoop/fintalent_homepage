...
const BarData = () => {
  ...
  return (
    <Card className="flex basis-full justify-between gap-x-4 px-7 py-8 lg:gap-x-12">
      {hiringCount === 0 ? (
        <div className="text-center text-base text-brand-blue lg:min-h-[300px] lg:w-[450px]">
          No data to show!
        </div>
      ) : (
        <>
          ...
          <div className="flex flex-col gap-4 px-2.5 pt-6 lg:max-h-[306px]">
